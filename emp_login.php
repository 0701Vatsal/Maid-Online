...
if (isset($_POST['login'])) 
{
    ...
    {	
      ...
      $_SESSION['pass'] = array();
    	header('location:http://localhost/online-Maid-service-master/home.php');
      }
    else
    {
